...
아래 값들은 겹쳐 쓰는 색이라 토큰·토큰 일치 판정에서 빠진다. 한쪽만 반투명이면 반대쪽 집합에 짝 없는 색이 뜨는데, 그 원인이 여기 있다.

${table([...figma.translucent], ['Figma: 색@불투명도', '노드'])}

${table([...story.translucent], ['구현: 색@불투명도', 'DOM 요소'])}
