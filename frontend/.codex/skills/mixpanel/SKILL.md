---
name: "mixpanel"
description: "모아동 Mixpanel 데이터를 분석하고 마크다운 리포트를 작성할 때 사용한다. 사용자 행동 분석, 퍼널, 리텐션, 이벤트 리포트, 인사이트, 주간 리포트 요청에 사용한다."
---
...
## Source: `.claude/commands/mixpanel.md`
...
> **A/B 테스트 유의성 검정**: `/mixpanel-ab` 커맨드를 사용하세요.
> 샘플 크기 계산, 피킹 방지, SRM 확인, 다중 비교 보정 등 실험 설계 체크리스트 포함.
