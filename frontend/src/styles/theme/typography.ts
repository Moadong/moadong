export const typography = {
  ...
  paragraph: {
    ...
    p2: { size: '16px', weight: 600 },
    p3: { size: '16px', weight: 500 },
    p4: { size: '16px', weight: 400 },
    p5: { size: '14px', weight: 500 },
    p6: { size: '14px', weight: 400 },
    p7: { size: '12px', weight: 400 },
  },
  button: {
    button1: { size: '14px', weight: 600 },
