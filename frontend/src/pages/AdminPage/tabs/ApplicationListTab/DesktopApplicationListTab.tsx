...
interface ApplicationListTabProps {
  ...
  handleGoToEditForm: (id: string) => void;
  handleToggleClick: (id: string, status: string) => void;
...
const DesktopApplicationListTab = ({
  semesterGroups,
  handleGoToNewForm,
  handleGoToEditForm,
  handleToggleClick,
...
export default DesktopApplicationListTab;
