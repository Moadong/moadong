...
import { SemesterGroup } from '@/types/application';
import { updateApplicationStatus } from '@/apis/application/updateApplication';
import { useQueryClient } from '@tanstack/react-query';
import useIsMobileView from '@/hooks/useIsMobileView';
import DesktopApplicationListTab from './DesktopApplicationListTab';
import MobileApplicationListTab from './MobileApplicationListTab';
...
const ApplicationListTab = () => {
  ...
  return isMobile ? (
    <MobileApplicationListTab {...props} />
  ) : (
    <DesktopApplicationListTab {...props} />
  );
};
