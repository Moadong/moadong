export function parseRecruitmentPeriod(periodStr: string): { recruitmentStart: Date | null, recruitmentEnd: Date | null } {
    ...
    return { recruitmentStart: convertToDate(parts[0]), recruitmentEnd: convertToDate(parts[1]) };
}